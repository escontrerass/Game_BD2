...
(
    id_detalle_registro_compra integer NOT NULL GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS public.tbl_dispositivo
(
    id_dispositivo integer NOT NULL GENERATED ALWAYS AS IDENTITY,
    dispositivo_nombre character varying COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT tbl_dispositivo_pkey PRIMARY KEY (id_dispositivo)
);

CREATE TABLE IF NOT EXISTS public.tbl_eliminacion_registro
(
    id_eliminacion_registro integer NOT NULL GENERATED ALWAYS AS IDENTITY,
...
(
    id_historial_registro integer NOT NULL GENERATED ALWAYS AS IDENTITY,
...
(
    id_item integer NOT NULL GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS public.tbl_os
(
    id_os integer NOT NULL GENERATED ALWAYS AS IDENTITY,
    os_nombre character varying COLLATE pg_catalog."default" NOT NULL,
    CONSTRAINT tbl_os_pkey PRIMARY KEY (id_os)
);

CREATE TABLE IF NOT EXISTS public.tbl_plataforma
(
    id_plataforma integer NOT NULL GENERATED ALWAYS AS IDENTITY,
...
CREATE TABLE IF NOT EXISTS public.tbl_plataforma_dispositivo_os
(
    id_plataforma_dispositivo_os integer NOT NULL GENERATED ALWAYS AS IDENTITY,
    id_plataforma integer NOT NULL,
    id_dispositivo integer NOT NULL,
    id_os integer NOT NULL,
    CONSTRAINT tbl_plataforma_dispositivo_os_pkey PRIMARY KEY (id_plataforma_dispositivo_os)
);

CREATE TABLE IF NOT EXISTS public.tbl_registro_compra
(
    id_registro_compra integer NOT NULL GENERATED ALWAYS AS IDENTITY,
    id_usuario integer NOT NULL,
...
(
    id_registro_recarga integer NOT NULL GENERATED ALWAYS AS IDENTITY,
    id_usuario integer NOT NULL,
...
(
    id_tipo_pago integer NOT NULL GENERATED ALWAYS AS IDENTITY,
...
(
    id_user_login integer NOT NULL GENERATED ALWAYS AS IDENTITY,
...
ALTER TABLE IF EXISTS public.tbl_plataforma_dispositivo_os
    ADD CONSTRAINT tbl_plataforma_dispositivo_os_id_dispositivo FOREIGN KEY (id_dispositivo)
    REFERENCES public.tbl_dispositivo (id_dispositivo) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;


ALTER TABLE IF EXISTS public.tbl_plataforma_dispositivo_os
    ADD CONSTRAINT tbl_plataforma_dispositivo_os_id_os FOREIGN KEY (id_os)
    REFERENCES public.tbl_os (id_os) MATCH SIMPLE
    ON UPDATE NO ACTION
    ON DELETE NO ACTION;


ALTER TABLE IF EXISTS public.tbl_plataforma_dispositivo_os
    ADD CONSTRAINT tbl_plataforma_dispositivo_os_id_plataforma FOREIGN KEY (id_plataforma)
